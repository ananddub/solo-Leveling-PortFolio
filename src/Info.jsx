        ...
        <div className="card col-sm-4" onClick={increaseCount}>
          ...
          <div className="card-body">
            {showQuetion.count != 4 && showQuetion.count != 5 ? (
              <>
                As a mobile developer with a passion for creativity, 
                I am dedicated to both the design and development aspects of an app,
                from concept to deployment. I focus on crafting intuitive
                interfaces, smooth interactions, and optimized performance to
                create standout mobile experiences.
              </>
            ) : (
              <>
                {quote}
